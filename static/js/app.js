...
document.addEventListener('DOMContentLoaded', () => {
  console.log("🎬 Inicializando efectos interactivos...");
  
  // 1. Cards giratorias y efectos
...
function renderPagina(pagina, productosFiltrados) {
  const cont = document.getElementById("productos"); // 👈 agregar esto
